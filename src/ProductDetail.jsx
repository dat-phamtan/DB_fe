    ...
    <div>
      ...
      {pickedProduct && selectedVariantData ? (
        ...
        <div className="mb-6 p-4 bg-yellow-100 text-yellow-700 rounded-lg">
          Không có dữ liệu biến thể cho sản phẩm này.
        </div>
      ) : null}
        ...
        {listProducts.map((product) => {
          return (
            ...
            >
              ...
              <p className="place-self-center">${product.min_price}</p>
              <p className="place-self-center">{product.total_stock}</p>
              <p className="place-self-center">{product.condition}</p>
              <div
